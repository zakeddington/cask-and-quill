...
const FERMENTATION_CHEMISTRY = 'Fermentation & Chemistry';
const INGREDIENTS_GRAIN = 'Ingredients & Grain';
const MALTING_MASHING = 'Malting & Mashing';
const MATURATION_WOOD = 'Maturation & Wood';
const MEASUREMENTS_LABELING = 'Measurements & Labeling';
const PEOPLE_PRODUCERS = 'People & Producers';
const REGIONS_TEROIR = 'Regions & Terroir';
...
export function getLexiconCategoryOptions() {
	return [
		{ value: '', label: 'Categories' },
		...LEXICON_CATEGORIES.map(category => ({ value: category, label: category }))
	];
}
